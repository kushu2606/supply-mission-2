...
function setup() {
	...
	rightBoxBody=Bodies.rectangle(boxPosition+200-20,boxY,20,100,{isStatic:true})
	World.add(world,rightBoxBody)
	
	downBox=createSprite(boxPosition+100,boxY+40,200,20)
	downBox.shapeColor=color("red")

	downBoxBody=Bodies.rectangle(boxPosition+100,boxY+45-20,200,20,{isStatic:true})
	World.add(world,downBoxBody)
